...
(function(){
    ...
    (function() {
    var p = "3334851", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3334851||'',
    guid:window.ftGUID_3334851||'',
    confID:window.ftConfID_3334851||'0',
    ftReturn: window.ftReturn_3334851||'',
    keyword:window.ftKeyword_3334851||'',
    ftId:window.ftId_3334851||'',
    ftImpId:window.ftImp3334851 && window.ftImp3334851.impID || '',
    campaignID: '97233',
    cID:'68441',
    pID:'3334851',
    creativeID:'2339295',
    exttrack:[],
    extscript:["https://cdn.doubleverify.com/dvtp_src.js?ctx=1000798&cmp=97233&sid=9979&plc=3334851&num=&adid=&advid=1487&adsrv=29&region=30&btreg=/3334851/&btadsrv=flashtalking&crt=2339295&crtname=&chnl=&unit=&pid=&uid=&tagtype=&dvtagver=6.1.src"],
    clickTags: ['http://servedby.flashtalking.com/click/8/97233;3334851;2339295;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=http://aspire.disney.com'],
    statBaseURL: 'http://stat8.flashtalking.com/reportV3/ft.stat?117141480-3334851;2339295;',
    centreAd: true,
    width:728,
    height:90,
    adType:'altimage'.toLowerCase(),
    altimg:'http://cdn.flashtalking.com/xre/333/3334851/2339295/image/2339295.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/97233;3334851;202;pixel;DoubleClickBidManager;DSKFPSTANASUPMGNGMCDMENGNAEmployeeEducationInvestmentProgram728x90PSLXV6/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref:'http://servedby.flashtalking.com/click/8/97233;3334851;2339295;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=http://aspire.disney.com',
    divID:'ftdiv3334851',
    altimgID:'ftalt3334851',
    alttext:'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp3334851 && parseInt(window.ftImp3334851.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m3334851') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3334851'),
    pageVisible: 'maybe',
...
//2017_10_12
//ftMinified
ft3334851.encodeClickCount = parseInt('1', 10) || 0;

ft3334851.addVClick = function(ct) {
    var o = this;

    //insert presuffix below between quotes
    var preSuffix = "?CMP=PMC-CRT|";

    var dcmCustom = window['ftCustom_' + o.pID];
    dcmCustom = dcmCustom.indexOf("___") > -1 ? dcmCustom.substr(0, dcmCustom.indexOf("___")) : dcmCustom.indexOf("\u0000=!;") > -1 ? dcmCustom.replace("\u0000=!;", "") : dcmCustom;
    dcmCustom = dcmCustom.split("_").join("|");
    ct = ct.indexOf("\u0000=!;") > -1 ? ct.replace("\u0000=!;", "UNDEFINED") : ct;
